...
">
        <span style="float: left;color: #5e5e5e;font-size: 20px;">艺术字控制输入台</span>
    </div>
    <form class="form-inline" method=""action="#"style="margin-top: 20px">
        <textarea class="form-control" rows="3" id="demo" style="width: 720px;height: 250px;display: table-cell;"placeholder="选好字体，背景色，点击提交即可生成"></textarea>
        <div class="form-group"style="margin-top: 10px">
            <select class="selectpicker form-control"id="family"style="width: 120px">
                <option style="font-family: 'Droid Sans Mono Slashed'">选择字体</option>
                @foreach($font as $v)
                <option style="font-family: {{$v->font_family}}">{{$v->font}}</option>
                 @endforeach
            </select>
            <label for="exampleInputName2">字体颜色</label>
            <input  type="text" class="form-control" id="color" placeholder="字体颜色"style="width:120px">
            <label for="exampleInputName2">字体大小</label>
            <input  type="text" class="form-control" id="sssss" placeholder="字体大小"style="width:120px">
            <label for="exampleInputName2">背景色</label>
            <input  type="text" class="form-control " id="background" placeholder="背景色"style="width: 120px">
            <input type="submit" class="form-control" id="submit" value="提交"style="background:#2ab27b;color: #dddddd">
        </div>
    </form>
</div>
</div>
<div id="div1" style="margin:20px auto 0;width:50px;
    ...
    <a download="" class="btn btn-info"style="width:50px;display:none;cursor: pointer;margin:20px auto 0;margin-right: 10px" id="download">下载</a>
</div>
