...
@section('content')
    ...
    <div style="margin-bottom: 30px">
        <form class="bs-example bs-example-form" role="form" action="{{ url('admin/font') }}">
            <div class="row">
                <div class="col-lg-6">
                    <div class="input-group">
                        <input type="text" class="form-control" name="font_family" placeholder="请输入您想搜索的文字样式"
                               value="{{ $re or '' }}">
